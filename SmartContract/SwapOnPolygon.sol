...
contract SwapOnPolygon is Ownable {
    ...
    address nativeWrappedCurrencyAddr = address(0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270);
    ...
    constructor() 
    {          
        _dexRouter = IUniswapV2Router02(dexRouterAddress);   
        _dexFactory = IUniswapV2Factory(dexFactoryAddress);
